...
> [!WARNING]
> This binding is experimental and has not been tested in MATLAB yet. It is not part of the supported Open Car Dynamics API. If you try it, please report successes, build failures, MATLAB-version details, and proposed improvements in the [Open Car Dynamics issue tracker](https://github.com/TUMFTM/Open-Car-Dynamics/issues). Community feedback is explicitly welcome.
>
> Parts of this MATLAB interface were generated using OpenAI Codex 5.6 Sol.
...
- MATLAB with MEX development files and a C++ compiler supported by that MATLAB release;
- CMake 3.18 or newer;
- a C++20 compiler;
...
The MEX file and its help file are written to `build/matlab/matlab`. Add that directory to the MATLAB path:
...
This cannot validate MATLAB's loader, ABI, or actual MEX runtime behavior. A successful build with real MathWorks headers and a MATLAB smoke test are still needed before the binding can be considered supported.
